            ...
            <div className="max-w-sm bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                ...
                <div className="flex justify-between mb-3">
                    <div className="flex justify-center items-center">
                        <h5 className="text-xl font-bold leading-none text-gray-900 dark:text-white pe-1">Trafico de la pagina</h5>
                    ...
                    <div>
                        ...
                        </svg><span className="sr-only">Descargar datos</span>
                        </button>
                ...
                <div>
                    <div className="flex" id="devices">
                        <div className="flex items-center me-4">
                            ...
                            <label htmlFor="desktop" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">PC</label>
                        </div>
                        <div className="flex items-center me-4">
                        ...
                        <div className="flex items-center me-4">
                            ...
                            <label htmlFor="mobile" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Telefono</label>
                        </div>
                    </div>
                </div>
