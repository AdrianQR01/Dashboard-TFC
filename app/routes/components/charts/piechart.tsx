...
export default function PieChart() {
    ...
    const options = {
        ...
        labels: ["Directo", "Busquedas", "Referencias"],
        dataLabels: {
            enabled: true,
            style: {
                ...
                <div className="flex justify-between items-start w-full">
                    <div className="flex-col items-center">
                        <div className="flex items-center mb-1">
                            <h1 className="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">Trafico de la pagina</h1>
                        ...
                        <button id="dateRangeButton" type="button" className="inline-flex items-center text-blue-700 dark:text-blue-600 font-medium hover:underline">31 Nov - 31 Dev <svg className="w-3 h-3 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                ...
                                <div date-rangepicker="true" datepicker-autohide="true" className="flex items-center">
                                    <div className="relative">
                                        <Label htmlFor="start-date">
                                            ...
                                            <input name="start" type="text" className="start-date bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Start date" />
                                        </Label>
                                    </div>
                                    ...
                                    <div className="relative">
                                        <Label htmlFor="end-date">End Date
                                            ...
                                            <input key="end" type="text" className="end-date bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="End date" />
                                        </Label>
                                    </div>
                                </div>
