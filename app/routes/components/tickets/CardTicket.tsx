...
export default function CardTicket() {
    return (
        <div className="flex justify-center p-1.5">
            <Link to={"1"} className="flex flex-col w-60 items-center bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
